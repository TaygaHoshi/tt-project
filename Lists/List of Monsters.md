...
---
## Bandit Archer
+ **Lore:** Low level bandit archers wear medium armor. They can shoot targets from long distances. They are found primarily near remote or deserted locations. They live in small or large groups and attack, pillage and loot whatever they can. 
+ **Level:** 1
+ **Health:** 60
+ **Aptitudes:** 
	+ 1 ACU
...
+ **Physical Armor:** 0
+ **Magic Armor:** 5
+ **Weapons:** Divine focus
+ **Precision roll:** (PRA) d10 + 2
+ **Resistances:** 7, 8 Faith
	+ +1 Faith from focus
+ **Skills**
	...
	+ (Full-turn action) (Divine spell) Vampiric Healing
		+ Radius: 10 meters
	...
	+ (Full-turn action) (Divine spell) Call Vampire Kins
...
+ **Skills**
	...
	+ (Prepared action) Opportunistic Slash
		+ Attacks the next foe who moves into or out of melee range.
...
+ **Skills**
	...
	+ (Full-turn action) (Combat technique) Crushing Charge
