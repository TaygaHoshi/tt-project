...
**Resistances:** 6
**Skills**
+ (Passive) Unsteady Aim
	+ If this bandit moves before they shoot or plans to move after, they must take a -2 penalty to precision roll.
+ (Projectile) Shoot
	+ Range: 15 meters.
...
+ (Triggered ability) Owl Form
	...
	+ In this form, this monster is flying and gains a +1 bonus to Evasion.
...
+ Severing Strike
	+ This attack's precision roll is made against Constitution.
	+ Applies bleeding (6 damage) for 3 rounds.
