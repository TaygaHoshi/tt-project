...
+ Any [[Equipment#Armor Types and Armor Rating|armor type]] of their choosing. This determines their physical and magical armor strength as well as their base [[Combat#Movement|movement speed]].
+ Two [[Equipment#Weapon Sets|weapon sets]] using the basic weapon items.
...
3. [[Character Creation#Encumbrance|Encumbrance]] also affects travel speed, explained in the next section. 
...
### Equipment
A player character can wear one set of [[Equipment#Armor Types and Armor Rating|armor]] and equip two [[Equipment#Weapon Sets|weapon sets]]. 
