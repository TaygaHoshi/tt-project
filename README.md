...
You can start reading the rules from [this website](https://sigil.tyghsh.cc). If you want to read the development version instead, check out [the test website](https://sigil-test.tyghsh.cc)
