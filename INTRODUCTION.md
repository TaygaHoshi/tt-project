...
Each [[Player Characters|player character]] consists of many unique and interesting choices: [[Armor & Weapons#Weapons|weapons]] provide active abilities, [[Armor & Weapons#Armor|armors]] are strong, [[Player Characters#Techniques|techniques]] carry an impact while not being overpowered, and the two [[Player Characters#Aptitudes|aptitudes]] allow players to fine tune how these abilities scale. Also, there are rarely any limitations: a [[Path of Guides|Guide]] or a [[Path of Sorcerers|Sorcerer]] can wear any type of armor and wield all weapons without penalties.

During their adventures, the party might come across and fight [[Introduction to Monsters|monsters]] such as charming snake-women, tickling sheep-men, elemental spirits as protectors of the nature or owl-vampires. In combat, a player character can use actions granted by their [[Armor & Weapons#Weapons|weapons]], or the [[Common Actions|common actions]] available to every character, to attack their foes. Should regular offence not be sufficient, the characters also have [[Player Characters#Techniques|techniques]] (and class abilities) granted by their [[Player Characters#Classes|Paths]], their main background in life, and [[Player Characters#Classes|Branches]], their secondary expertise. A character's Path also defines their health.

They can also endure the offence of enemies through negating it with their innate [[Player Characters#Resistances|resistances]] or mitigating it through equipment such as [[Armor & Weapons#Armor|armor]] and defensive [[Weapons - Off Hand|off-hand weapons]], or taking it and keeping on fighting with their health pool. Using the right technique at the right time can provide an edge in combat. Just make sure to spare some [[Player Characters#Energy|energy]] if you’re expecting more fighting soon, as techniques require energy which you need to [[Player Characters#Resting and Sleeping|rest]] to replenish properly.

## Reading this website
The bulk of the rules used within combat encounters are in [[Combat|the combat page]]. While it is a good place to dive into the game, you might want to start from [[Player Characters|the character creation page]] for a more gradual introduction. This step can be followed through via [the character creation website](https://sigil-create.tyghsh.cc).

From there, the natural follow-up is the set of pages that explain what a player character is made of:
- The pages under _Character - Paths_,
- The pages under _Character - Branches_,
- The [[Skills|character skills]] page.
