...
**Execution Time:** Action
**Requirements:**
	A stuck thrown weapon in the target.
	A free main hand.
**Explanation:**
	Ignores weapon precision.
...
**Execution Time:** Action
**Explanation:** 
	You use a [[Character Creation#Inventory Management#Quick Access Slots|quick access item]] from your inventory.
	This action can be used to apply a potion to an adjacent target.
